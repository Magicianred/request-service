...
namespace RequestService.Handlers
{
    public class GetQuestionsByActivityHandler : IRequestHandler<GetQuestionsByActivitiesRequest, GetQuestionsByActivtiesResponse>
    {
        ...
        {            
            var questions = await _repository.GetActivityQuestions(request.ActivitesRequest.Activities, request.RequestHelpFormVariantRequest.RequestHelpFormVariant, request.RequestHelpFormStage, cancellationToken);
