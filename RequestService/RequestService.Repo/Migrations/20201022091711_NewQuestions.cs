    ...
    public partial class NewQuestions : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 13, "", "Where does the prescription need collecting from?", (byte)2 },
                    { 12, "", "Please tell us what you need from the shop (make sure to include the size, brand, and any other important details)", (byte)2 }
                });
        }
