...
{
    public partial class AnythingElseTextPart2 : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValues: new object[] { 1, 10, 1 },
                columns: new[] { "Order", "PlaceholderText" },
                values: new object[] { 2, "For example, if it’s a request for some shopping and you know what you want, you could give us the list." });
