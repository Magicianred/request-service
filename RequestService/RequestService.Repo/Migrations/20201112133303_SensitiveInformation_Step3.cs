...
{
    public partial class SensitiveInformation_Step3 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                ...
                table: "ActivityQuestions",
                keyColumns: new[] { "ActivityID", "QuestionID", "RequestFormVariantID" },
                keyValues: new object[] { 15, 9, 8 });

            migrationBuilder.DeleteData(
                schema: "QuestionSet",
                table: "ActivityQuestions",
                keyColumns: new[] { "ActivityID", "QuestionID", "RequestFormVariantID" },
                keyValues: new object[] { 16, 9, 8 });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "Order", "PlaceholderText" },
                values: new object[] { 2, "For example, any mobility or communication needs, or special instructions for the volunteer. **Please don’t include any personal or sensitive information in this box**." });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "Order", "PlaceholderText", "Subtext" },
                values: new object[] { 3, "For example, a door entry code, or contact details for a friend / relative / caregiver.", "We will only share this information with a volunteer after they have accepted your request" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "Order", "PlaceholderText" },
                values: new object[] { 2, "For example, let us know if the prescription needs to be paid for, or if there are any mobility or communication needs or special instructions for the volunteer. **Please don’t include any personal or sensitive information in this box**." });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "Order", "Subtext" },
                values: new object[] { 2, "This information will be visible to volunteers deciding whether to accept the request" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 14,
                column: "Name",
                value: "Is there any other personal or sensitive information the volunteer needs to know to complete the request?");
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValues: new object[] { 1, 10, 1 },
                columns: new[] { "Order", "PlaceholderText" },
                values: new object[] { 2, "For example, any special instructions for the volunteer." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValues: new object[] { 1, 14, 1 },
                columns: new[] { "Order", "PlaceholderText", "Subtext" },
                values: new object[] { 3, "For example, phone John on XXXXX when you’re ten minutes away. Or use code 1234 to access the main gate etc.", null });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValues: new object[] { 2, 10, 1 },
                columns: new[] { "Order", "PlaceholderText" },
                values: new object[] { 2, "For example, let us know if the prescription needs to be paid for." });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 4, 9, 2, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 3, 9, 3, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 2, 9, 3, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 1, 9, 3, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 13, 9, 2, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 12, 9, 2, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 11, 9, 2, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 10, 9, 2, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 9, 9, 2, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 8, 9, 2, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 2, 9, 1, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 3, 9, 1, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 3, 9, 2, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 4, 9, 1, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 4, 9, 3, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 6, 9, 1, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 7, 9, 1, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 8, 9, 1, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 9, 9, 1, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 10, 9, 1, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 11, 9, 1, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 12, 9, 1, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 1, 9, 2, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 2, 9, 2, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 7, 9, 2, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 6, 9, 2, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 5, 9, 2, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 5, 9, 1, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 5, 9, 3, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 7, 9, 5, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 7, 9, 3, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    ...
                    { 2, 9, 8, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 11, 9, 8, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 16, 9, 8, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 15, 9, 8, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    ...
                    { 1, 9, 8, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 6, 9, 3, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    ...
                    { 14, 9, 6, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 8, 9, 3, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 9, 9, 3, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 10, 9, 3, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 11, 9, 3, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 12, 9, 3, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 12, 9, 4, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 1, 9, 5, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    ...
                    { 2, 9, 5, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 4, 9, 5, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 5, 9, 5, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 6, 9, 5, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 8, 9, 5, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 9, 9, 5, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 10, 9, 5, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 11, 9, 5, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 12, 9, 5, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 3, 9, 5, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null },
                    { 1, 9, 1, "details2", 1, "For example, do you have any specific language requirement or hearing issues that we should know about?", 2, false, null }
                });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 14,
                column: "Name",
                value: "Any sensitve information to share?");
        }
    }
}
